...
![image](https://github.com/user-attachments/assets/5e699ded-e8b6-4caa-9e21-18896ea0dd9f)

В правой части экрана можно будет увидеть кнопку `Run workflow`, на которую необходимо кликнуть
